...
class _MyProjectsPageState extends State<MyProjectsPage> {
  ...
  final List<String> _filters = ['Todos', 'Publicado', 'Rascunho'];
        ...
        body: SafeArea(
          child: Consumer<ProjectListViewModel>(
            builder: (context, vm, _) {
              final filtered = _applyFilters(vm.projetos);
              ...
              return Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () => _navigateToAddProject(context, vm),
                  ...
                  if (!vm.loading && _applyFilters(vm.projetos).isNotEmpty)
  ...
  void _navigateToEditProject(BuildContext context, Project projeto, ProjectListViewModel vm) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => ProjectFormPage(projetoId: projeto.id)),
    ).then((updated) {
